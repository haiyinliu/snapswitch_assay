...
datafile <- "Table_Thuy.csv"                   # file name of your MFI table exported from FlowJo
...
facs_raw <- facs_significant %>%
  ...
  mutate(
    ...
    # CHANGE 251007: Cy5 is not reported as pure value and only reported as LSA - WT, therefore subtraction happens afterwards 
    Cy5 = Cy5_raw,
