...
datafile <- "240903.csv"                   # file name of your MFI table exported from FlowJo
exp_title <- "240903 Jurkat"        # date and name of the experiment
...
sample_info <- read_csv("parameters/samples_240903.csv")
column_info <- read_csv("parameters/column_info_HL.csv")
...
facs <- facs_unclean %>%
  ...
  filter(!grepl('mystery|Unstained|LNP20', TUBENAME)) %>% # removes "mystery" and Aurora "Unstained" tubes
